...
void createHistogram(TH1D* &histo, const char* histoName)
{
	...
	{
		double xbins[] = {0., 2.7, 3.4, 4.0, 4.4, 4.7, 5.0, 5.6, 5.8, 6.0, 6.2, 6.4, 6.6, 6.8, 7.3, 9.5, 13.0, 17.0, 40.};
	...
	{
		double xbins[] = {-2.4, -1.6, -1.4, -1.2, -1.0, -0.8, -0.5, -0.2, 0, 0.2, 0.5, 0.8, 1.0, 1.2, 1.4, 1.6, 2.4};
