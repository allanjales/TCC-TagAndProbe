...
//List of files
const char *files[] = {"../data/data_histoall.root",
						"../data/Run2011AMuOnia_mergeNtuple.root",
						"../data/JPsiToMuMu_mergeMCNtuple.root",
						"../data/Run2011A_MuOnia_Upsilon.root",
						"../data/Upsilon1SToMuMu_MC_full.root"};
...
//Which file of files (variable above) should be used
int useFile = 1;
